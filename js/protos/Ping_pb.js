...
proto.Ping.toObject = function(includeInstance, msg) {
  var f, obj = {
    pingnum: jspb.Message.getFieldWithDefault(msg, 1, 0)
  };
...
/**
 * optional int64 pingNum = 1;
 * @return {number}
 */
proto.Ping.prototype.getPingnum = function() {
 ...
 */
proto.Ping.prototype.setPingnum = function(value) {
